...
const HOW_IT_WORKS = {
  ...
  line2:
    "The chances of you getting a match are directly proportional to the number of friends you get to sign up ;)",
  line3: "Get. Set. Poke!",
};
  ...
  return (
    <div id="container" className="mt-4  py-2">
      ...
      <div className="pt-2 text-sm font-normal">
        ...
        <p className="pt-2">{HOW_IT_WORKS.line2}</p>
        <p className="pt-2 font-semibold text-primary">{HOW_IT_WORKS.line3}</p>
      </div>
    </div>
  );
};
